...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_1(W(1,8),W(1,7),GC_100,MDL_MT, FK_MDL_WT,W(1,10)) ! count 4
      CALL FFV2_1(W(1,9),W(1,7),GC_100,MDL_MT, FK_MDL_WT,W(1,11)) ! count 4
      ...
      CALL FFV2_2(W(1,15),W(1,14),GC_100,MDL_MT, FK_MDL_WT,W(1,17)) ! count 4
      CALL FFV2_2(W(1,16),W(1,14),GC_100,MDL_MT, FK_MDL_WT,W(1,18)) ! count 4
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO, FK_ZERO,W(1,19)) ! count 4
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO, FK_ZERO,W(1,20)) ! count 4
