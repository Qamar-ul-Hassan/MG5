...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WW)
      ...
      CALL FFV2_1(W(1,8),W(1,7),GC_100,MDL_MT, FK_MDL_WT,W(1,10)) ! count 14
      CALL FFV2_1(W(1,9),W(1,7),GC_100,MDL_MT, FK_MDL_WT,W(1,11)) ! count 14
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,12)) ! count 1
      CALL IXXXXX(P(0,7),ZERO,+1,-1*IC(7),W(1,13)) ! count 1
      CALL FFV2_3(W(1,13),W(1,12),GC_100,MDL_MW, FK_MDL_WW,W(1,14)) ! count 2
      CALL IXXXXX(P(0,8),MDL_MB,+1,-1*IC(8),W(1,15)) ! count 1
      CALL IXXXXX(P(0,8),MDL_MB,-1,-1*IC(8),W(1,16)) ! count 1
      CALL FFV2_2(W(1,15),W(1,14),GC_100,MDL_MT, FK_MDL_WT,W(1,17)) ! count 14
      CALL FFV2_2(W(1,16),W(1,14),GC_100,MDL_MT, FK_MDL_WT,W(1,18)) ! count 14
      CALL VVV1P0_1(W(1,1),W(1,3),GC_10,ZERO, FK_ZERO,W(1,19)) ! count 4
      CALL VVV1P0_1(W(1,2),W(1,4),GC_10,ZERO, FK_ZERO,W(1,22)) ! count 4
      CALL FFV1P1N_1(W(1,10), W(1,19), GC_11, TMP(1))
      call CombineAmp(2,
     & (/15,16/), 
     & (/17,18/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,10), W(1,22), GC_11, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/17,18/),
     & TMP, W, AMP(1,1))
     ...
     & (/17,18/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,11), W(1,22), GC_11, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/17,18/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV1_1(W(1,10),W(1,1),GC_11,MDL_MT, ZERO,W(1,23)) ! count 4
      CALL FFV1_1(W(1,10),W(1,2),GC_11,MDL_MT, ZERO,W(1,24)) ! count 4
      CALL FFV1_1(W(1,11),W(1,1),GC_11,MDL_MT, ZERO,W(1,25)) ! count 4
      CALL FFV1_1(W(1,11),W(1,2),GC_11,MDL_MT, ZERO,W(1,26)) ! count 4
      CALL FFV1P1N_2(W(1,17), W(1,3), GC_11, TMP(1))
      call CombineAmp(4,
     & (/15,7,13,5/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,17), W(1,4), GC_11, TMP(1))
      call CombineAmp(4,
     & (/11,3,9,1/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,18), W(1,3), GC_11, TMP(1))
      call CombineAmp(4,
     & (/16,8,14,6/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,2))
      CALL FFV1P1N_2(W(1,18), W(1,4), GC_11, TMP(1))
      call CombineAmp(4,
     & (/12,4,10,2/), 
     & (/23,24,25,26/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL FFV1_2(W(1,17),W(1,1),GC_11,MDL_MT, ZERO,W(1,27)) ! count 4
      CALL FFV1_2(W(1,17),W(1,2),GC_11,MDL_MT, ZERO,W(1,28)) ! count 4
      CALL FFV1_2(W(1,18),W(1,1),GC_11,MDL_MT, ZERO,W(1,29)) ! count 4
      CALL FFV1_2(W(1,18),W(1,2),GC_11,MDL_MT, ZERO,W(1,30)) ! count 4
      CALL FFV1P1N_1(W(1,10), W(1,3), GC_11, TMP(1))
      call CombineAmp(4,
     & (/15,7,16,8/), 
     & (/27,28,29,30/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_1(W(1,10), W(1,4), GC_11, TMP(1))
      call CombineAmp(4,
     & (/11,3,12,4/), 
     & (/27,28,29,30/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_1(W(1,11), W(1,3), GC_11, TMP(1))
      call CombineAmp(4,
     & (/13,5,14,6/), 
     & (/27,28,29,30/),
     & TMP, W, AMP(1,3))
      CALL FFV1P1N_1(W(1,11), W(1,4), GC_11, TMP(1))
      call CombineAmp(4,
     & (/9,1,10,2/), 
     & (/27,28,29,30/),
